...
<tr class="TableRow1">
<td class="TableRow1" colspan="2"><span style="font-weight: bold; float: left;">&nbsp;<a href="Topic.php?id=<?php echo $_GET['id']; ?>&amp;ForumID=<?php echo $_GET['ForumID']; ?>&amp;CatID=<?php echo $_GET['CatID']; ?>&amp;act=View"><?php echo $TopicName; ?></a></span><?php if($SkinSet['TopicLayout']!="Type 2") { ?>
...
$requery="SELECT * FROM ".$Settings['sqltable']."Members WHERE ID=".$MyUserID."";
